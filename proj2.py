...
connection_string = 'mysql+pymysql://root:@localhost:3306/StockAnalysis'
...
st.image('C:/Users/WELCOME/Desktop/pandasProject/datadriven.png')
...
with st.sidebar:
    menu = option_menu(
        "Menu",
        ["Home","Data Cleaning", "Volatility Analysis", "Cumulative Return", "Sector-wise Performance", "Stock Price Correlation", "Top 5 Gainers and Losers"],
        icons=['house','brush', 'bar-chart', 'graph-up', 'pie-chart', 'graph-up-arrow', 'trophy'],
        menu_icon="cast",
        default_index=0,
        styles={
...
connection_string = 'root:@localhost:3306/StockAnalysis'
if menu == "Home":
    st.write("""
...
""")
    ...
    yaml_folder_path = st.text_input("YAML Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\data')
    output_folder_path = st.text_input("Output Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\output')
    ...
    csv_folder_path = st.text_input("CSV Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\output')
    volatility_output_folder_path = st.text_input("Volatility Output Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\VolatilityAnalysis')
    ...
    csv_folder_path = st.text_input("CSV Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\output')
    cumulative_return_output_folder_path = st.text_input("Cumulative Return Output Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\CumulativeReturns')
    ...
    sector_data = pd.read_csv(r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\Sectordata\Sector_data - Sheet1.csv')
    # Initialize a dictionary to store cumulative returns for each sector
    sector_returns = {}
    # Folder containing the 50 CSV files
    csv_folder_path = r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\output'
    ...
    output_csv_path = r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\SectorwisePerformance\average_sector_returns.csv'
    ...
    output_csv_path = r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\StockPriceCorrelation\correlation_matrix.csv'
    ...
    data_folder_path = st.text_input("Data Folder Path", r'C:\Users\WELCOME\Desktop\pandasProject\StockAnalysis\output')
